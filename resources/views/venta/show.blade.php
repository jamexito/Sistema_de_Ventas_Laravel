              ...
              <div class="table-responsive col-md-12">
                ...
                <tfoot>
                   ...
                   <tr>
                        ...
                        <th><p align="right">S/.{{number_format($venta->total,2)}}</p></th>
                    </tr>

                    <tr>
                        <th colspan="4"><p align="right">TOTAL IMPUESTO (18%):</p></th>
                        <th><p align="right">S/.{{number_format($venta->total*18/100,2)}}</p></th>
                    </tr>

                    <tr>
                        <th  colspan="4"><p align="right">TOTAL PAGAR:</p></th>
                        <th><p align="right">S/.{{number_format($venta->total+($venta->total*18/100),2)}}</p></th>
                    </tr>
                </tfoot>
