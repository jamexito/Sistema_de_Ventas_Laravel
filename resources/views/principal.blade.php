...
<header class="app-header navbar">
    ...
    <div class="app-body">
        ...
        {{-- @include('plantilla.sidebar') con filtro de usuario ponemos el de abajo --}}
    ...
    <footer class="app-footer">
        <span><a href="#">inventorSystem.com</a> &copy; 2019</span>
        <span class="ml-auto">Desarrollado por <a href="#">inventorSystem.com</a></span>
    </footer>
    ...
    <script>
        ...
        // INICIO DE LA VENTANA MODAL PARA DESACTIVAR CATEGORIA
       ...
       // modal.find('.modal-body #subirImagen').html("<img src="img/producto/imagen_modal_editar">");
        ...
        /*EDITAR PRODUCTO EN VENTANA MODAL*/
        $('#abrirmodalEditarProd').on('show.bs.modal', function (event) {
       ...
       // modal.find('.modal-body #subirImagen').html("<img src="img/producto/imagen_modal_editar">");
        ...
        // INICIO DE LA VENTANA MODAL PARA DESACTIVAR PRODUCTO
        $('#cambiarEstado').on('show.bs.modal',function (event) {
            // console.log('modal abierto');
            var button = $(event.relatedTarget)
            var id_producto = button.data('id_producto')
