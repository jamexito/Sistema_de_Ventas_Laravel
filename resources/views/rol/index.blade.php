...
<main class="main">
            ...
            <div class="card-header">
               ...
               <h2>Listado de Roles</h2><br/>
                ...
                {{-- <button class="btn btn-primary btn-lg" type="button" data-toggle="modal" data-target="#abrirmodal">
                    <i class="fa fa-plus fa-2x"></i>&nbsp;&nbsp;Agregar Rol
                </button> --}}
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        @foreach ($roles as $rol)
                            ...
                            <tr>
                                ...
                                {{-- <td>
                                    <button type="button" class="btn btn-info btn-md" data-id_rol="{{$rol->id}}" data-nombre="{{$rol->nombre}}" data-descripcion="{{$rol->descripcion}}" data-toggle="modal" data-target="#abrirmodalEditar">
                                ...
                                {{-- <td>
                                    ...
                                    @if ($rol->condicion)
                                        ...
                                        <button type="button" class="btn btn-danger btn-sm" data-id_rol="{{$rol->id}}" data-toggle="modal" data-target="#cambiarEstado">
                                            <i class="fa fa-lock fa-2x"></i> Desactivar
                                        </button>

                                    @else

                                        <button type="button" class="btn btn-success btn-sm" data-id_rol="{{$rol->id}}" data-toggle="modal" data-target="#cambiarEstado">
    ...
    <div class="modal fade" id="cambiarEstado" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
            <div class="modal-dialog modal-primary modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Cambiar Estado del Rol</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <span aria-hidden="true">×</span>
                        </button>
                    </div>
