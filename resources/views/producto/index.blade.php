...
<main class="main">
                    ...
                    <tbody>
                        @foreach ($productos as $prod)
                            ...
                            <tr>
                                ...
                                <td>{{$prod->stock}}</td>
                                <td>
                                    <img src="{{asset('storage/img/producto/'.$prod->imagen)}}" id="imagen1" alt="{{$prod->imagen}}" class="img-responsive" width="100px" height="100px">
                                </td>
                                <td>
                                    @if ($prod->condicion=="1")
                                ...
                                <td>
                                <button type="button" class="btn btn-info btn-md" data-id_producto="{{$prod->id}}" data-id_categoria="{{$prod->idcategoria}}" data-codigo="{{$prod->codigo}}" data-stock="{{$prod->stock}}" data-nombre="{{$prod->nombre}}" data-precio_venta="{{$prod->precio_venta}}"  data-toggle="modal" data-target="#abrirmodalEditarProd">
    ...
    <!--Fin del modal-->
     ...
     <div class="modal fade" id="abrirmodalEditarProd" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="display: none;" aria-hidden="true">
        <div class="modal-dialog modal-primary modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
